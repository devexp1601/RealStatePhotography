...
# Sky replacement settings
SKY_LIBRARY_FOLDER = os.path.join(BASE_DIR, 'sky_library')

for folder in [UPLOAD_FOLDER, WATCH_FOLDER, OUTPUT_FOLDER, HDR_OUTPUT_FOLDER, ENHANCED_OUTPUT_FOLDER, SKY_LIBRARY_FOLDER]:
